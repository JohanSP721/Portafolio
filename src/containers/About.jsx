...
import "../assets/styles/containers/About.css";
...
export const About = () =>
{
	return (
		<>
			<Helmet>
				<title>Sobre mi | Johan Sarmiento Peña</title>
				<meta name="description" content="Presentación y perfil profesional de Johan Sarmiento Peña" />
			</Helmet>
